...
public class DoubleJumpSignScript : MonoBehaviour
{
    ...
    private void OnTriggerStay2D(Collider2D collision)
    {
        ...
        {
            signText.text = "Jump anytime while midair for a second jump. Timing your jump correctly will allow you to reach difficult areas.";
