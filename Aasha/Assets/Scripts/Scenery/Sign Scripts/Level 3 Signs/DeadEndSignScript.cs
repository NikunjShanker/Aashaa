...
public class DeadEndSignScript : MonoBehaviour
{
    ...
    private void OnTriggerStay2D(Collider2D collision)
    {
        ...
        {
            signText.text = "The door is right there behind this wall! Unfortunately you'll have to figure out a different way to get there...";
